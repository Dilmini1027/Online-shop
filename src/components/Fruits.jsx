...
const Fruits = () => {
  ...
  const clotheTypes = [
    ...
    { title: 'Frocks', link: 'clothes/frock', image: '/frocks/6e3a9e75-3c2e-44df-859c-7a0589dd2064.jpeg', price: '2kg - Rs 3500.00' },
     { title: 'Trousers', link: '/cakes/red-velvet-1', image: '/frocks/6e8614d9-5488-4487-9ff6-6845512d0f29.jpeg', price: '2kg - Rs 3000.00' },
    { title: 'Lehenga', link: '/cakes/lemon-2', image: '/cakes/f3923894-34f8-4426-8672-1c5a6ce2e164.jpeg',  price: '2kg - Rs 3500.00' },
    { title: 'Sarees', link: '/cakes/black-forest-1', image: '/cakes/This gluten-free Black Forest Cake is a healthier….jpeg',  price: '1.5kg - Rs 3000.00' },
    { title: 'Hot Shorts', link: '/cakes/cheese-2', image: '/cakes/This carrot cake recipe is easy to make and….jpeg', price: '0.5kg - Rs 1200.00' },
     { title: 'Blouse', link: '/cup/cup-1', image: '/cup/Christmas Tree Cupcakes, a simple Christmas….jpeg', price: '5 pcs - Rs 1500.00' },
    { title: 'Salvar', link: '/cup/cup-2', image: '/cup/dc7f46bc-0388-4174-bb79-1b92ac186ffa.jpeg',  price: '5 pcs - Rs 2000.00' },
  ...
  const filteredClothes = clotheTypes.filter(fruit => {
  ...
  return (
    <>
                  ...
                  >
                    {cat.subItems.map((subItem, subIdx) => (
                      <a key={subIdx} onClick={() => {
                        if (cat.title.toLowerCase() === 'fruits') {
      ...
      <Container maxWidth={false} sx={{ p: 1, mt: 2 }}>
        ...
        >
          {filteredClothes.map((fruit, index) => (
            <Card
              key={index}
              sx={{
                cursor: 'pointer',
